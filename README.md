...
Sekisei is a [re-frame](https://github.com/day8/re-frame) application designed to be a helper of Number Cross Word puzzle solving.
...
* [`src/clj/sekisei/`](src/clj/sekisei/): CSS compilation source files (Clojure,
[Garden](https://github.com/noprompt/garden))
* [`src/cljs/sekisei/`](src/cljs/sekisei/): SPA source files (ClojureScript,
[re-frame](https://github.com/Day8/re-frame))
  - [`core.cljs`](src/cljs/sekisei/core.cljs): contains the SPA entry point, `init`
...
7. Clone this repo and open a terminal in the `sekisei` project root directory
...
in the [`src/clj/sekisei/`](src/clj/sekisei/) directory. CSS files are compiled
...
The `debug?` variable in [`config.cljs`](src/cljs/sekisei/config.cljs) defaults to `true` in
...
```clj
(ns sekisei.example
  (:require [sekisei.config :as config])
